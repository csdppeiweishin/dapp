...
function App() {
    ...
    const sendIt = async (event) => {
        ...
        try{
            ...
            alert(
                `Failed to load web3. Check that Metamask connected this page to a blockchain account.`
            );
            console.error(error);
            setLoading(false);
        }
    ...
    return (
        <div className="App"  >
            <header className="App-header">
                ...
                <h1 className="h1" >Security Tools Lab 2 - DAPP Distributed Storage</h1>
                <span  style={{color: '#5919fa', fontSize: '0.7em'}}><i>Shin Pei Wei</i></span>
            ...
            <form onSubmit={sendIt}>
                ...
                <Button variant="outline-primary" size="lg" type="submit"> 2. Publish to IPFS</Button>
                }
            </form>
            <hr/> 

            <h3> Get Blockchain Details </h3>
            <Button variant="outline-primary" size="lg" onClick = {getDetails}> 3. Pull Transaction Details </Button> 
            <hr/>
            ...
            <Table size="sm" bordered responsive>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Storing transaction BlockNumber </td>
                        <td> : </td>
                        <td>{blockNumber}</td>
                    </tr>
                    <tr>
                        <td>Storing transaction Gas Used </td>
                        <td> : </td>
                        <td>{gasUsed}</td>
                    </tr>
                </tbody>
